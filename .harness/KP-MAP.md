...
| S20 | Typed edge styles (4 types), edge legend, panel type badges, larger labels | ✅ Edges have semantic meaning, legend visible | Mobile panel untested, could add edge type filter |
